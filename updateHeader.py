          ...
          <div class="container">
            ...
            <div class="row align-items-center">
              <div class="col-md-4 g-brd-right--md g-brd-secondary-light-v2 g-mb-30">
                <!-- Copyright -->
                <p class="g-color-secondary-light-v1 g-font-size-12 mb-0">&copy; 2017-2019 All Rights Reserved.</p>
                <!-- End Copyright -->
              </div>
              ...
              <div class="col-md-8 g-brd-right--md g-brd-secondary-light-v2 g-mb-30">
                ...
                <ul class="list-inline mb-0">
                  ...
                  <li class="list-inline-item g-px-10">
                    <a class="u-link-v5 g-color-black-opacity-0_5 g-font-size-12">Last modified: August 2020</a>
                  </li>
                </ul>
                <!-- End Links -->
              </div>
